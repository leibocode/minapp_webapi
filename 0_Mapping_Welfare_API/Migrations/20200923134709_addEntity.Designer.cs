            ...
            modelBuilder.Entity("_02_Mapping_Welfare_Domain.DomainModels.Comments", b =>
                {
                    ...
                    b.Property<string>("WechatUserOpenId")
            ...
            modelBuilder.Entity("_02_Mapping_Welfare_Domain.DomainModels.Comments", b =>
                {
                    ...
                    b.HasOne("_02_Mapping_Welfare_Domain.DomainModels.WechatUser", "WechatUser")
                        .WithMany()
                        .HasForeignKey("WechatUserOpenId");
                });
            ...
            modelBuilder.Entity("_02_Mapping_Welfare_Domain.DomainModels.WechatUser", b =>
                {
                    ...
                    b.HasOne("_02_Mapping_Welfare_Domain.DomainModels.WechatUser", null)
                        .WithMany("WechatUsers")
                        .HasForeignKey("WechatUserOpenId");
                });
